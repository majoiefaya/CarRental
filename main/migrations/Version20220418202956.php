 ...
 */
final class Version20220418202956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BCBF396750 FOREIGN KEY (id) REFERENCES actions_infos (id) ON DELETE CASCADE');
    }
